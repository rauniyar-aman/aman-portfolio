  ...
  return (
    <div className="-m-4">
      ...
      {vm.includeDeclaration && vm.declarationText && (
        // Full-width, outside the two-column flex row — the sidebar/main
        // split is a fixed decorative layout, not the document's reading
        // flow, so the declaration breaks out of it to stay the true last
        // thing on the page rather than getting stuck inside one column.
        <div className="px-[0.9em] pb-[0.9em]">
